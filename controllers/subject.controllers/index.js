...
const getAll = async (request, response) => {
    try {
        ...
        response.status(400).send({ message: 'Failed to get all subjects', ...err });
    }
}
...
const getById = async (request, response) => {
    try {
        ...
        response.status(400).send({ message: 'Failed to get subject by id', ...err });
    }
}
...
const remove = async (request, response) => {
    try {
        ...
        response.status(200).send({ message: `Remove subject id = ${id} successfully`, ...result });
    } catch (err) {
